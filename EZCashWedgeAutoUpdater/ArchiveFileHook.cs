            ...
            try
            {
                ...
                if (fileName.Contains("_00") || fileName.Contains("_0"))
                {
                    ...
                    if (File.Exists(staticPath))
                    {
                        ...
                        // This frees up "AutoUpdateLog.txt" immediately
                        ...
                        Task.Run(() =>
                        {
                            try
                            {
                                ...
                                {
                                    archive.CreateEntryFromFile(tempFile, "AutoUpdateLog.txt");
                                }
                    ...
                    // 5. IMMEDIATE RETURN: Give Serilog a fresh AutoUpdateLog.txt right away
